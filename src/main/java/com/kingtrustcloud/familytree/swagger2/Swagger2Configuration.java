package com.kingtrustcloud.familytree.swagger2;
 ...
 * Swagger2 启动类
 * 启动条件：
 * 1，配置文件中tpbx.swagger.enabled=true
 * 2，配置文件中不存在：tpbx.swagger.enabled 值
 *
 * @author tan
 * @date 2019/11/6 9:20
 */
@Configuration
@ConditionalOnProperty(name = "familytree.swagger.enabled", havingValue = "true", matchIfMissing = true)
@EnableSwagger2
...
public class Swagger2Configuration implements WebMvcConfigurer {
    ...
    public static class ZhSecurityConfiguration {
        ...
        @ConditionalOnProperty(name = "familytree.swagger.production", havingValue = "true")
        ...
        @Bean
        @ConditionalOnMissingBean
        @ConditionalOnProperty(name = "familytree.swagger.basic.enable", havingValue = "true")
        ...
        @ConditionalOnMissingBean
        @ConditionalOnProperty(name = "familytree.swagger.markdown.enable", havingValue = "true")
